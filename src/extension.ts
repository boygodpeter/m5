...
//我好想死 我好累 我編譯器還沒念完 
function getWebviewContent(escapedCode: string): string {
      ...
      panel.webview.onDidReceiveMessage(
        async (message) => {
          if (message.command === 'save') {
            ...
            const codeToSave = message.code as string;
